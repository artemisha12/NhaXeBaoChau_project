...
export default function RouteTable() {
  const { routes, addRoute, updateRoute, toggleRouteStatus } = useAdmin();
    ...
    <div className="overflow-hidden rounded-3xl border border-[#e8dccb] bg-[#fffdf8] shadow-sm font-sans">
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#04101b]/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md max-h-[90vh] overflow-y-auto rounded-3xl bg-[#fffdf8] border border-[#e8dccb] p-6 shadow-2xl animate-fade-in font-sans">
